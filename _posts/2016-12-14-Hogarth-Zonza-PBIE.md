...
_image currently attached to email, to clarify with Hogarth about what can be shared before putting public_ (image of embedded report in Zonza application)
